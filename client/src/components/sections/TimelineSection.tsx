...
const events: TimelineEvent[] = [
  ...
  },
  {
    year: "1983",
    title: "세례 받음",
    description: "기쁨이 있는교회에서 세례를 받고 본격적인 신앙의 여정을 시작. 이때부터 매주 빠짐없이 예배에 참석하는 삶을 살아감.",
    icon: "✝",
  ...
  },
  {
    year: "1995",
    title: "집사 임명",
    description: "기쁨이 있는교회 집사로 임명되어 교회 건축 위원회와 재정 위원회에서 헌신적으로 봉사를 시작함.",
    icon: "✝",
  ...
  },
  {
    year: "현재",
    title: "신앙의 여정은 계속됩니다",
    description: "손자녀 3명의 자랑스러운 할아버지이자, 기쁨이 있는교회의 든든한 기둥으로 오늘도 묵묵히 신앙의 길을 걸어가고 있음.",
    icon: "✝",
